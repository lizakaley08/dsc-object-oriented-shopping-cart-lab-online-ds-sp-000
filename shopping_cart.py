class ShoppingCart:
    ...
    def median_item_price(self):
        prices = [item["price"] for item in self.items] # pulls prices for items into list
        length = len(prices) # how many prices
        if (length%2 == 0): # if length divided by 2 is 0 then:
